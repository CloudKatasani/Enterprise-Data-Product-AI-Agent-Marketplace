...
ALTER TABLE DP_TRN_001.T_DP_TRN_001 ADD DATA METRIC FUNCTION GOVERNANCE.DMF_NOT_NULL ON (shipment_leg_id);

-- QR-TRN-001-02: freshness / stream_lag_under (severity critical)
ALTER TABLE DP_TRN_001.T_DP_TRN_001 ADD DATA METRIC FUNCTION GOVERNANCE.DMF_STREAM_LAG_UNDER ON (*);

-- QR-TRN-001-03: validity / in_reference_set (severity high)
ALTER TABLE DP_TRN_001.T_DP_TRN_001 ADD DATA METRIC FUNCTION GOVERNANCE.DMF_IN_REFERENCE_SET ON (carrier);

-- QR-TRN-001-04: uniqueness / unique_at_grain (severity critical)
ALTER TABLE DP_TRN_001.T_DP_TRN_001 ADD DATA METRIC FUNCTION GOVERNANCE.DMF_UNIQUE_AT_GRAIN ON (shipment_leg_id);

-- QR-TRN-001-05: consistency / not_greater_than_available (severity high)
ALTER TABLE DP_TRN_001.T_DP_TRN_001 ADD DATA METRIC FUNCTION GOVERNANCE.DMF_NOT_GREATER_THAN_AVAILABLE ON (revenue_hours);
