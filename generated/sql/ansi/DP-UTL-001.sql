...
-- SELECT 'QR-UTL-001-01' AS rule_id, ... FROM DP_UTL_001.T_DP_UTL_001;

-- QR-UTL-001-02: freshness / stream_lag_under (severity critical)
-- SELECT 'QR-UTL-001-02' AS rule_id, ... FROM DP_UTL_001.T_DP_UTL_001;

-- QR-UTL-001-03: validity / in_reference_set (severity critical)
-- SELECT 'QR-UTL-001-03' AS rule_id, ... FROM DP_UTL_001.T_DP_UTL_001;

-- QR-UTL-001-04: uniqueness / unique_at_grain (severity critical)
-- SELECT 'QR-UTL-001-04' AS rule_id, ... FROM DP_UTL_001.T_DP_UTL_001;

-- QR-UTL-001-05: accuracy / reconcile_to_oms (severity critical)
-- SELECT 'QR-UTL-001-05' AS rule_id, ... FROM DP_UTL_001.T_DP_UTL_001;
