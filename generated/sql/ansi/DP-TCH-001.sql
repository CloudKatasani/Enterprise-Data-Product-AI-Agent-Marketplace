...
-- SELECT 'QR-TCH-001-01' AS rule_id, ... FROM DP_TCH_001.T_DP_TCH_001;

-- QR-TCH-001-02: freshness / partition_completion_by (severity high)
-- SELECT 'QR-TCH-001-02' AS rule_id, ... FROM DP_TCH_001.T_DP_TCH_001;

-- QR-TCH-001-03: validity / in_reference_set (severity high)
-- SELECT 'QR-TCH-001-03' AS rule_id, ... FROM DP_TCH_001.T_DP_TCH_001;

-- QR-TCH-001-04: uniqueness / unique_at_grain (severity critical)
-- SELECT 'QR-TCH-001-04' AS rule_id, ... FROM DP_TCH_001.T_DP_TCH_001;

-- QR-TCH-001-05: consistency / implies_entitled_or_trial (severity medium)
-- SELECT 'QR-TCH-001-05' AS rule_id, ... FROM DP_TCH_001.T_DP_TCH_001;
