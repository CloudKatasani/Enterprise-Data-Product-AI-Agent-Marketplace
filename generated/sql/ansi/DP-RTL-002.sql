...
-- SELECT 'QR-RTL-002-01' AS rule_id, ... FROM DP_RTL_002.T_DP_RTL_002;

-- QR-RTL-002-02: freshness / partition_completion_by (severity critical)
-- SELECT 'QR-RTL-002-02' AS rule_id, ... FROM DP_RTL_002.T_DP_RTL_002;

-- QR-RTL-002-03: validity / in_reference_set (severity high)
-- SELECT 'QR-RTL-002-03' AS rule_id, ... FROM DP_RTL_002.T_DP_RTL_002;

-- QR-RTL-002-04: uniqueness / unique_at_grain (severity critical)
-- SELECT 'QR-RTL-002-04' AS rule_id, ... FROM DP_RTL_002.T_DP_RTL_002;

-- QR-RTL-002-05: consistency / non_negative (severity high)
-- SELECT 'QR-RTL-002-05' AS rule_id, ... FROM DP_RTL_002.T_DP_RTL_002;
