...
-- SELECT 'QR-INS-002-01' AS rule_id, ... FROM DP_INS_002.T_DP_INS_002;

-- QR-INS-002-02: freshness / partition_completion_by (severity high)
-- SELECT 'QR-INS-002-02' AS rule_id, ... FROM DP_INS_002.T_DP_INS_002;

-- QR-INS-002-03: validity / in_reference_set (severity high)
-- SELECT 'QR-INS-002-03' AS rule_id, ... FROM DP_INS_002.T_DP_INS_002;

-- QR-INS-002-04: uniqueness / unique_at_grain (severity critical)
-- SELECT 'QR-INS-002-04' AS rule_id, ... FROM DP_INS_002.T_DP_INS_002;

-- QR-INS-002-05: accuracy / reconcile_to_general_ledger (severity critical)
-- SELECT 'QR-INS-002-05' AS rule_id, ... FROM DP_INS_002.T_DP_INS_002;
