...
"""MCP server for DP-BNK-001 — Customer Financial 360.
...
server = ProductServer(
    ...
    sliceable_columns=['segment', 'tenure_band', 'value_band', 'product_family'],
