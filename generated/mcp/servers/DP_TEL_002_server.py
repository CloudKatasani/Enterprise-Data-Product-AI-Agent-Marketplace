...
"""MCP server for DP-TEL-002 — Network Experience & Fault Signal.
...
server = ProductServer(
    ...
    certified_kpis=['KPI-NETAVAIL-006', 'KPI-DROP-007', 'KPI-THRPUT-008', 'KPI-FMTTR-009', 'KPI-IMPHRS-010'],
    sliceable_columns=['site_class', 'technology', 'fault_class'],
    supported_grains=['day', 'week', 'month', 'quarter'],
    row_limit=16000,
)


@server.tool("query_site_network_asset")
def query_site_network_asset(request: ToolRequest) -> ToolResponse:
