...
"""MCP server for DP-HLT-001 — Patient Care Journey & Readmission.
...
server = ProductServer(
    ...
    sliceable_columns=['unit', 'payer', 'clinic'],
    supported_grains=['month', 'quarter', 'year'],
    row_limit=11200,
)


@server.tool("query_patient_clinical")
def query_patient_clinical(request: ToolRequest) -> ToolResponse:
