...
"""MCP server for DP-INS-002 — Policy & Underwriting Portfolio.
...
server = ProductServer(
    ...
    certified_kpis=['KPI-WRITTENPREM-031', 'KPI-POLRETEN-032', 'KPI-QTB-033', 'KPI-RATEADQ-034', 'KPI-EXPCONC-035'],
    sliceable_columns=['coverage_line', 'segment', 'channel', 'peril'],
    supported_grains=['week', 'month', 'quarter', 'year'],
    row_limit=10400,
)


@server.tool("query_policy_product")
def query_policy_product(request: ToolRequest) -> ToolResponse:
