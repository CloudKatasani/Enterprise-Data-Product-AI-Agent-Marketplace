...
"""MCP server for DP-TRN-001 — Fleet Movement & Delivery Performance.
...
server = ProductServer(
    ...
    certified_kpis=['KPI-OTD-056', 'KPI-CPM-057', 'KPI-DWELL-058', 'KPI-ASSETUTIL-059', 'KPI-EXCRATE-060'],
    sliceable_columns=['lane', 'carrier', 'service_level', 'facility', 'equipment_type', 'exception_type'],
    supported_grains=['day', 'week', 'month', 'quarter'],
    row_limit=14000,
)


@server.tool("query_shipment_operations")
def query_shipment_operations(request: ToolRequest) -> ToolResponse:
