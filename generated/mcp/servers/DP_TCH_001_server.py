...
"""MCP server for DP-TCH-001 — Product Usage & Feature Adoption.
...
server = ProductServer(
    ...
    sliceable_columns=['feature', 'plan_tier', 'segment', 'acquisition_channel'],
    supported_grains=['day', 'week', 'month', 'quarter', 'year'],
    row_limit=24000,
)


@server.tool("query_account_product")
def query_account_product(request: ToolRequest) -> ToolResponse:
